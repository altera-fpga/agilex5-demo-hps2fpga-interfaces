...
PATCH_FILES="
../../../common_sw/atf_patches/platform_def.h.patch
"
...
../../../common_sw/u-boot_patches/arch-arm-dts-socfpga_agilex5_socdk.dts.uart1.patch \
../../../common_sw/u-boot_patches/arch-arm-dts-socfpga_agilex5_socdk-u-boot.dtsi.patch \
../../../common_sw/u-boot_patches/arch-arm-dts-socfpga_agilex5.dtsi.uart1.patch \
../../../common_sw/u-boot_patches/arch-arm-dts-socfpga_agilex5-u-boot.dtsi.uart1.patch
"
for NEXT_PATCH in ${PATCH_FILES:?}
do
	patch -p1 \
