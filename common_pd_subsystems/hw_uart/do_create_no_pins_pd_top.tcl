...
proc do_create_no_pins_pd_top {} {
	...
	add_connection config_clk_250m.clkout/uart.clk_250m_in_clk
	set_connection_parameter_value config_clk_250m.clkout/uart.clk_250m_in_clk clockDomainSysInfo {1}
	set_connection_parameter_value config_clk_250m.clkout/uart.clk_250m_in_clk clockRateSysInfo {}
	set_connection_parameter_value config_clk_250m.clkout/uart.clk_250m_in_clk clockResetSysInfo {}
	set_connection_parameter_value config_clk_250m.clkout/uart.clk_250m_in_clk resetDomainSysInfo {1}
	...
	add_connection no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart
	set_connection_parameter_value no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart endPort {}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart endPortLSB {0}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart startPort {}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart startPortLSB {0}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_uart1/uart.xlate_uart_hps_uart width {0}
	add_connection uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp
	set_connection_parameter_value uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPort {}
	set_connection_parameter_value uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPortLSB {0}
	set_connection_parameter_value uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPort {}
	set_connection_parameter_value uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPortLSB {0}
	set_connection_parameter_value uart.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp width {0}
	...
	add_connection usermode_entry.ninit_done/uart.reset_br_in_reset
	set_connection_parameter_value usermode_entry.ninit_done/uart.reset_br_in_reset clockDomainSysInfo {16}
	set_connection_parameter_value usermode_entry.ninit_done/uart.reset_br_in_reset clockResetSysInfo {}
	set_connection_parameter_value usermode_entry.ninit_done/uart.reset_br_in_reset resetDomainSysInfo {16}
