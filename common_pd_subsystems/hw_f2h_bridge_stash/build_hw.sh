...
qsys-script --qpf=none --script=../../scripts/update_sysid.tcl --system-file=f2h_bridge_stash.qsys && \
qsys-script --qpf=none --script=../../scripts/sync_sysid.tcl --system-file=f2h_bridge_stash.qsys && \
