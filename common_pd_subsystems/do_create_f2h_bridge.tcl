...
proc do_create_f2h_bridge {} {
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation f2h_adapt_256b
	remove_instantiation_interfaces_and_ports
	add_instantiation_interface clock clock INPUT
	set_instantiation_interface_parameter_value clock clockRate {0}
	set_instantiation_interface_parameter_value clock externallyDriven {false}
	...
	set_component_parameter_value GPIN_CONSTANT {541602374}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	...
	add_connection clock_br.out_clk/f2h_adapt_256b.clock
	set_connection_parameter_value clock_br.out_clk/f2h_adapt_256b.clock clockDomainSysInfo {-1}
	set_connection_parameter_value clock_br.out_clk/f2h_adapt_256b.clock clockRateSysInfo {}
	set_connection_parameter_value clock_br.out_clk/f2h_adapt_256b.clock clockResetSysInfo {}
	set_connection_parameter_value clock_br.out_clk/f2h_adapt_256b.clock resetDomainSysInfo {-1}
	...
	add_connection limiter_removal_256b.m0/f2h_adapt_256b.axi4_subordinate
	set_connection_parameter_value limiter_removal_256b.m0/f2h_adapt_256b.axi4_subordinate addressMapSysInfo {<address-map><slave name='f2h_adapt_256b.axi4_subordinate' start='0x0' end='0x100000000' datawidth='256' /></address-map>}
	...
	set_connection_parameter_value limiter_removal_256b.m0/f2h_adapt_256b.axi4_subordinate qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value limiter_removal_256b.m0/f2h_adapt_256b.axi4_subordinate qsys_mm.enableAllPipelines {FALSE}
	...
	set_connection_parameter_value limiter_removal_256b.m0/f2h_adapt_256b.axi4_subordinate qsys_mm.maxAdditionalLatency {1}
	...
	add_connection reset_br.out_reset/f2h_adapt_256b.reset
	set_connection_parameter_value reset_br.out_reset/f2h_adapt_256b.reset clockDomainSysInfo {-1}
	set_connection_parameter_value reset_br.out_reset/f2h_adapt_256b.reset clockResetSysInfo {}
	set_connection_parameter_value reset_br.out_reset/f2h_adapt_256b.reset resetDomainSysInfo {-1}
...
<bonusData>
 ...
 <element __value="f2h_adapt_256b">
 ...
 <element __value="sysid">
  <datum __value="_sortIndex" value="3" type="int" />
	...
	set_module_property FILE {f2h_bridge.qsys}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {f2h_bridge}

	# save the system
	sync_sysinfo_parameters
	save_system f2h_bridge
}
