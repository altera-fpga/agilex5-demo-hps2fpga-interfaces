...
proc do_create_no_pins_pd_top {} {
	...
	add_connection emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0
	set_connection_parameter_value emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0 endPort {}
	set_connection_parameter_value emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0 endPortLSB {0}
	set_connection_parameter_value emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0 startPort {}
	set_connection_parameter_value emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0 startPortLSB {0}
	set_connection_parameter_value emac.emac_loop_hps_emac_loop/no_pins_hps.agilex_5_soc_emac0 width {0}
	add_connection emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp
	set_connection_parameter_value emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPort {}
	set_connection_parameter_value emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPortLSB {0}
	set_connection_parameter_value emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPort {}
	set_connection_parameter_value emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPortLSB {0}
	set_connection_parameter_value emac.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp width {0}
