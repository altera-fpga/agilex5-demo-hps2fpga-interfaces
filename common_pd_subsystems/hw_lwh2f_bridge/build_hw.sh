...
qsys-script --qpf=none --script=../../scripts/update_sysid.tcl --system-file=lwh2f_bridge.qsys && \
qsys-script --qpf=none --script=../../scripts/sync_sysid.tcl --system-file=lwh2f_bridge.qsys && \
