...
proc do_create_no_pins_pd_top {} {
	...
	add_instance spi_bridge spi_bridge
	...
	add_connection config_clk_250m.clkout/spi_bridge.clock_250m_in_clk
	set_connection_parameter_value config_clk_250m.clkout/spi_bridge.clock_250m_in_clk clockDomainSysInfo {1}
	set_connection_parameter_value config_clk_250m.clkout/spi_bridge.clock_250m_in_clk clockRateSysInfo {}
	set_connection_parameter_value config_clk_250m.clkout/spi_bridge.clock_250m_in_clk clockResetSysInfo {}
	set_connection_parameter_value config_clk_250m.clkout/spi_bridge.clock_250m_in_clk resetDomainSysInfo {1}
	...
	add_connection no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0 endPort {}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0 endPortLSB {0}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0 startPort {}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0 startPortLSB {0}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0/spi_bridge.xlate_spi_hps_spim0 width {0}
	add_connection no_pins_hps.agilex_5_soc_spim0_sclk_out/spi_bridge.xlate_spi_hps_spim0_sclk_out
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0_sclk_out/spi_bridge.xlate_spi_hps_spim0_sclk_out clockDomainSysInfo {2}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0_sclk_out/spi_bridge.xlate_spi_hps_spim0_sclk_out clockRateSysInfo {}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0_sclk_out/spi_bridge.xlate_spi_hps_spim0_sclk_out clockResetSysInfo {<info><clock name="xlate_spi_hps_spim0_sclk_out" rate="0" domain="2" /></info>}
	set_connection_parameter_value no_pins_hps.agilex_5_soc_spim0_sclk_out/spi_bridge.xlate_spi_hps_spim0_sclk_out resetDomainSysInfo {2}
	add_connection spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp
	set_connection_parameter_value spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPort {}
	set_connection_parameter_value spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp endPortLSB {0}
	set_connection_parameter_value spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPort {}
	set_connection_parameter_value spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp startPortLSB {0}
	set_connection_parameter_value spi_bridge.hps_gp_split_hps_gp/no_pins_hps.agilex_5_soc_hps_gp width {0}
	...
	add_connection usermode_entry.ninit_done/spi_bridge.reset_br_in_reset
	set_connection_parameter_value usermode_entry.ninit_done/spi_bridge.reset_br_in_reset clockDomainSysInfo {16}
	set_connection_parameter_value usermode_entry.ninit_done/spi_bridge.reset_br_in_reset clockResetSysInfo {}
	set_connection_parameter_value usermode_entry.ninit_done/spi_bridge.reset_br_in_reset resetDomainSysInfo {16}
