...
proc do_create_lwh2f_bridge {} {
	...
	save_instantiation
	add_component gp_in_const ip/lwh2f_bridge/gp_in_const.ip hps_gp_in_constant gp_in_const 1.0
	load_component gp_in_const
	set_component_parameter_value GPIN_CONSTANT {843601740}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	...
	save_instantiation
	add_component hps_gp_split ip/lwh2f_bridge/hps_gp_split.ip hps_gp_splitter hps_gp_split 1.0
	...
	save_instantiation
	add_component ocram_2k_0 ip/no_pins_pd_top/ocram_2k_0.ip intel_onchip_memory ocram_2k_0 1.4.10
	...
	set_instantiation_assignment_value embeddedsw.CMacro.INIT_CONTENTS_FILE {ocram_2k_0_ocram_2k_0}
	...
	set_instantiation_assignment_value embeddedsw.memoryInfo.MEM_INIT_FILENAME {ocram_2k_0_ocram_2k_0}
	...
	save_instantiation
	add_component ocram_2k_1 ip/no_pins_pd_top/ocram_2k_1.ip intel_onchip_memory ocram_2k_1 1.4.10
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation ocram_2k_1
	remove_instantiation_interfaces_and_ports
	set_instantiation_assignment_value embeddedsw.CMacro.ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR {0}
	set_instantiation_assignment_value embeddedsw.CMacro.CONTENTS_INFO {""}
	set_instantiation_assignment_value embeddedsw.CMacro.DUAL_PORT {0}
	set_instantiation_assignment_value embeddedsw.CMacro.GUI_RAM_BLOCK_TYPE {AUTO}
	set_instantiation_assignment_value embeddedsw.CMacro.INIT_CONTENTS_FILE {ocram_2k_1_ocram_2k_1}
	set_instantiation_assignment_value embeddedsw.CMacro.INIT_MEM_CONTENT {1}
	set_instantiation_assignment_value embeddedsw.CMacro.INSTANCE_ID {NONE}
	set_instantiation_assignment_value embeddedsw.CMacro.NON_DEFAULT_INIT_FILE_ENABLED {0}
	set_instantiation_assignment_value embeddedsw.CMacro.RAM_BLOCK_TYPE {AUTO}
	...
	set_instantiation_assignment_value embeddedsw.memoryInfo.HEX_INSTALL_DIR {QPF_DIR}
	set_instantiation_assignment_value embeddedsw.memoryInfo.MEM_INIT_DATA_WIDTH {32}
	set_instantiation_assignment_value embeddedsw.memoryInfo.MEM_INIT_FILENAME {ocram_2k_1_ocram_2k_1}
	set_instantiation_assignment_value postgeneration.simulation.init_file.param_name {INIT_FILE}
	set_instantiation_assignment_value postgeneration.simulation.init_file.type {MEM_INIT}
	add_instantiation_interface clk1 clock INPUT
	set_instantiation_interface_parameter_value clk1 clockRate {0}
	...
	set_interface_property ocram_2k_0_clk1 EXPORT_OF ocram_2k_0.clk1
	set_interface_property ocram_2k_0_axi_s1 EXPORT_OF ocram_2k_0.axi_s1
	set_interface_property ocram_2k_0_reset1 EXPORT_OF ocram_2k_0.reset1
	set_interface_property ocram_2k_1_clk1 EXPORT_OF ocram_2k_1.clk1
	set_interface_property ocram_2k_1_axi_s1 EXPORT_OF ocram_2k_1.axi_s1
	set_interface_property ocram_2k_1_reset1 EXPORT_OF ocram_2k_1.reset1
...
<bonusData>
 ...
 <element __value="ocram_2k_0">
  <datum __value="_sortIndex" value="1" type="int" />
 </element>
 <element __value="ocram_2k_1">
 ...
 <element __value="sysid">
  <datum __value="_sortIndex" value="5" type="int" />
	...
	set_module_property FILE {lwh2f_bridge.qsys}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {lwh2f_bridge}

	# save the system
	sync_sysinfo_parameters
	save_system lwh2f_bridge
}
