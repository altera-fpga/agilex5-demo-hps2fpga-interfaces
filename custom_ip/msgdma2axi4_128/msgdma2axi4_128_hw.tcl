...
set_module_property NAME msgdma2axi4_128
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME msgdma2axi4_128
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL msgdma2axi4_128
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file msgdma2axi4_128.v VERILOG PATH msgdma2axi4_128.v TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL msgdma2axi4_128
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file msgdma2axi4_128.v VERILOG PATH msgdma2axi4_128.v

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL msgdma2axi4_128
...
# data width related
add_interface_port s0 s0_read_byteenable byteenable Input 16
# data width related
add_interface_port s0 s0_read_readdata readdata Output 128
...
# data width related
add_interface_port s0 s0_read_burstcount burstcount Input 9
...
# data width related
add_interface_port s1 s1_write_byteenable byteenable Input 16
# data width related
add_interface_port s1 s1_write_writedata writedata Input 128
add_interface_port s1 s1_write_waitrequest waitrequest Output 1
# data width related
add_interface_port s1 s1_write_burstcount burstcount Input 9
...
# data width related
add_interface_port m0 m0_rdata rdata Input 128
...
# data width related
add_interface_port m0 m0_wdata wdata Output 128
add_interface_port m0 m0_wlast wlast Output 1
add_interface_port m0 m0_wready wready Input 1
# data width related
add_interface_port m0 m0_wstrb wstrb Output 16
